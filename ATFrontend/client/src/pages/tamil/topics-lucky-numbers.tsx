...
const TamilTopicsLuckyNumbers = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>அதிர்ஷ்ட எண்கள் | Lucky Numbers Tamil</title>
        <meta name="description" content="அதிர்ஷ்ட எண்கள்" />
        <meta property="og:title" content="அதிர்ஷ்ட எண்கள் | Lucky Numbers Tamil" />
        <meta property="og:description" content="அதிர்ஷ்ட எண்கள்" />
...
export default TamilTopicsLuckyNumbers;