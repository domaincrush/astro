...
const TamilSimpleEastIndianChart = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>எளிய கிழக்கு இந்திய ஜாதகம் | Simple East Indian Chart</title>
        <meta name="description" content="எளிய கிழக்கு இந்திய ஜாதகம்" />
        <meta property="og:title" content="எளிய கிழக்கு இந்திய ஜாதகம் | Simple East Indian Chart" />
        <meta property="og:description" content="எளிய கிழக்கு இந்திய ஜாதகம்" />
...
export default TamilSimpleEastIndianChart;