...
const TamilPalmistry = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கைரேகை சாஸ்திரம் | Palmistry Tamil</title>
        <meta name="description" content="கைரேகை சாஸ்திரம்" />
        <meta property="og:title" content="கைரேகை சாஸ்திரம் | Palmistry Tamil" />
        <meta property="og:description" content="கைரேகை சாஸ்திரம்" />
