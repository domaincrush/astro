...
const TamilPlanetTransit2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>2025 கிரக பெயர்ச்சி | Planet Transit 2025</title>
        <meta name="description" content="2025 கிரக பெயர்ச்சி" />
        <meta property="og:title" content="2025 கிரக பெயர்ச்சி | Planet Transit 2025" />
        <meta property="og:description" content="2025 கிரக பெயர்ச்சி" />
...
export default TamilPlanetTransit2025;