...
const TamilRefundPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பணம் திரும்பப்பெறும் கொள்கை | Refund Policy Tamil</title>
        <meta name="description" content="பணம் திரும்பப்பெறும் கொள்கை" />
        <meta property="og:title" content="பணம் திரும்பப்பெறும் கொள்கை | Refund Policy Tamil" />
        <meta property="og:description" content="பணம் திரும்பப்பெறும் கொள்கை" />
...
export default TamilRefundPolicy;