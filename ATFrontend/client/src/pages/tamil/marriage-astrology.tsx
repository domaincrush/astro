...
const TamilMarriageAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>திருமண ஜோதிடம் | Marriage Astrology Tamil</title>
        <meta name="description" content="திருமண ஜோதிடம்" />
        <meta property="og:title" content="திருமண ஜோதிடம் | Marriage Astrology Tamil" />
        <meta property="og:description" content="திருமண ஜோதிடம்" />
...
export default TamilMarriageAstrology;