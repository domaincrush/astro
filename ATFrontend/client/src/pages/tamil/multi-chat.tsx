...
const TamilMultiChat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பல அரட்டை | Multi Chat</title>
        <meta name="description" content="பல அரட்டை" />
        <meta property="og:title" content="பல அரட்டை | Multi Chat" />
        <meta property="og:description" content="பல அரட்டை" />
