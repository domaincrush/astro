...
const TamilPaymentSuccess = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பணம் செலுத்துதல் வெற்றி | Payment Success</title>
        <meta name="description" content="பணம் செலுத்துதல் வெற்றி" />
        <meta property="og:title" content="பணம் செலுத்துதல் வெற்றி | Payment Success" />
        <meta property="og:description" content="பணம் செலுத்துதல் வெற்றி" />
...
export default TamilPaymentSuccess;