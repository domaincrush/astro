...
const TamilWalletRecharge = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>வாலெட் ரீசார்ஜ் | Wallet Recharge Tamil</title>
        <meta name="description" content="வாலெட் ரீசார்ஜ்" />
        <meta property="og:title" content="வாலெட் ரீசார்ஜ் | Wallet Recharge Tamil" />
        <meta property="og:description" content="வாலெட் ரீசார்ஜ்" />
...
export default TamilWalletRecharge;