...
const TamilLoveCompatibility = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>காதல் பொருத்தம் | Love Compatibility</title>
        <meta name="description" content="காதல் பொருத்தம்" />
        <meta property="og:title" content="காதல் பொருத்தம் | Love Compatibility" />
...
export default TamilLoveCompatibility;