...
const TamilTopicsJupiterTransit = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>குரு கிரக பெயர்ச்சி | Jupiter Transit Tamil</title>
        <meta name="description" content="குரு கிரக பெயர்ச்சி" />
        <meta property="og:title" content="குரு கிரக பெயர்ச்சி | Jupiter Transit Tamil" />
        <meta property="og:description" content="குரு கிரக பெயர்ச்சி" />
...
export default TamilTopicsJupiterTransit;