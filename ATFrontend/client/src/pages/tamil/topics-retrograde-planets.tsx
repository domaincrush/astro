...
const TamilTopicsRetrogradePlanets = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>வக்ர கிரகங்கள் | Retrograde Planets Tamil</title>
        <meta name="description" content="வக்ர கிரகங்கள்" />
        <meta property="og:title" content="வக்ர கிரகங்கள் | Retrograde Planets Tamil" />
        <meta property="og:description" content="வக்ர கிரகங்கள்" />
...
export default TamilTopicsRetrogradePlanets;