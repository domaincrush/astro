...
const TamilBabyNaming = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>குழந்தை பெயர் சூட்டுதல் | Baby Naming Tamil</title>
        <meta name="description" content="குழந்தை பெயர் சூட்டுதல்" />
        <meta property="og:title" content="குழந்தை பெயர் சூட்டுதல் | Baby Naming Tamil" />
        <meta property="og:description" content="குழந்தை பெயர் சூட்டுதல்" />
...
export default TamilBabyNaming;