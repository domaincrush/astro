...
const TamilChildrenProgenyAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>குழந்தை சந்ததி ஜோதிடம் | Children Progeny Astrology</title>
        <meta name="description" content="குழந்தை சந்ததி ஜோதிடம்" />
        <meta property="og:title" content="குழந்தை சந்ததி ஜோதிடம் | Children Progeny Astrology" />
        <meta property="og:description" content="குழந்தை சந்ததி ஜோதிடம்" />
...
export default TamilChildrenProgenyAstrology;