...
const TamilTopicsRahuKetuTransit = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ராகு கேது பெயர்ச்சி | Rahu Ketu Transit</title>
        <meta name="description" content="ராகு கேது பெயர்ச்சி" />
        <meta property="og:title" content="ராகு கேது பெயர்ச்சி | Rahu Ketu Transit" />
        <meta property="og:description" content="ராகு கேது பெயர்ச்சி" />
...
export default TamilTopicsRahuKetuTransit;