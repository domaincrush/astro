...
const TamilPremiumReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பிரீமியம் அறிக்கை | Premium Report Tamil</title>
        <meta name="description" content="பிரீமியம் அறிக்கை" />
        <meta property="og:title" content="பிரீமியம் அறிக்கை | Premium Report Tamil" />
        <meta property="og:description" content="பிரீமியம் அறிக்கை" />
...
export default TamilPremiumReport;