...
const TamilPhase3Test = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கட்டம் 3 சோதனை | Phase 3 Test</title>
        <meta name="description" content="கட்டம் 3 சோதனை" />
        <meta property="og:title" content="கட்டம் 3 சோதனை | Phase 3 Test" />
        <meta property="og:description" content="கட்டம் 3 சோதனை" />
...
export default TamilPhase3Test;