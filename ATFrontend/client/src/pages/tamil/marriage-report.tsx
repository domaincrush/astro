...
const TamilMarriageReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>திருமண அறிக்கை | Marriage Report</title>
        <meta name="description" content="திருமண அறிக்கை" />
        <meta property="og:title" content="திருமண அறிக்கை | Marriage Report" />
        <meta property="og:description" content="திருமண அறிக்கை" />
