...
const TamilResetPin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பின் மீட்டமைப்பு | Reset PIN Tamil</title>
        <meta name="description" content="பின் மீட்டமைப்பு" />
        <meta property="og:title" content="பின் மீட்டமைப்பு | Reset PIN Tamil" />
        <meta property="og:description" content="பின் மீட்டமைப்பு" />
