...
const TamilBlog = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>வலைப்பதிவு | Blog Tamil</title>
        <meta name="description" content="வலைப்பதிவு" />
        <meta property="og:title" content="வலைப்பதிவு | Blog Tamil" />
        <meta property="og:description" content="வலைப்பதிவு" />
