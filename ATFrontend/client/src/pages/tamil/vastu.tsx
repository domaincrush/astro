...
const TamilVastu = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>வாஸ்து சாஸ்திரம் | Vastu Shastra Tamil</title>
        <meta name="description" content="வாஸ்து சாஸ்திரம்" />
        <meta property="og:title" content="வாஸ்து சாஸ்திரம் | Vastu Shastra Tamil" />
        <meta property="og:description" content="வாஸ்து சாஸ்திரம்" />
