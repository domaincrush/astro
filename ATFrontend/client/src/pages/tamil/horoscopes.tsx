...
const TamilHoroscopes = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ராசி பலன்கள் | Horoscopes Tamil</title>
        <meta name="description" content="ராசி பலன்கள்" />
        <meta property="og:title" content="ராசி பலன்கள் | Horoscopes Tamil" />
        <meta property="og:description" content="ராசி பலன்கள்" />
...
export default TamilHoroscopes;