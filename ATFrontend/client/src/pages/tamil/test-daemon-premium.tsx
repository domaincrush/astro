...
const TamilTestDaemonPremium = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>டேமன் பிரீமியம் சோதனை | Daemon Premium Test</title>
        <meta name="description" content="டேமன் பிரீமியம் சோதனை" />
        <meta property="og:title" content="டேமன் பிரீமியம் சோதனை | Daemon Premium Test" />
        <meta property="og:description" content="டேமன் பிரீமியம் சோதனை" />
...
export default TamilTestDaemonPremium;