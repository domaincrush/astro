...
const TamilTestJyotishyam = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஜ்யோதிஷ்யம் சோதனை | Jyotishyam Test</title>
        <meta name="description" content="ஜ்யோதிஷ்யம் சோதனை" />
        <meta property="og:title" content="ஜ்யோதிஷ்யம் சோதனை | Jyotishyam Test" />
        <meta property="og:description" content="ஜ்யோதிஷ்யம் சோதனை" />
...
export default TamilTestJyotishyam;