...
const TamilTopicsShaniMahadasha = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சனி மகாதசா | Shani Mahadasha Tamil</title>
        <meta name="description" content="சனி மகாதசா" />
        <meta property="og:title" content="சனி மகாதசா | Shani Mahadasha Tamil" />
        <meta property="og:description" content="சனி மகாதசா" />
...
export default TamilTopicsShaniMahadasha;