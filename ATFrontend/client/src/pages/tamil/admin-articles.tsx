...
const TamilAdminArticles = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>அட்மின் கட்டுரைகள் | Admin Articles</title>
        <meta name="description" content="அட்மின் கட்டுரைகள்" />
        <meta property="og:title" content="அட்மின் கட்டுரைகள் | Admin Articles" />
        <meta property="og:description" content="அட்மின் கட்டுரைகள்" />
...
export default TamilAdminArticles;