...
const TamilAuthLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>அங்கீகார உள்நுழைவு | Auth Login Tamil</title>
        <meta name="description" content="அங்கீகார உள்நுழைவு" />
        <meta property="og:title" content="அங்கீகார உள்நுழைவு | Auth Login Tamil" />
        <meta property="og:description" content="அங்கீகார உள்நுழைவு" />
