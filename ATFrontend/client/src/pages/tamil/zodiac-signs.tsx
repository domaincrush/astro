...
const TamilZodiacSigns = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ராசி குறியீடுகள் | Zodiac Signs Tamil</title>
        <meta name="description" content="ராசி குறியீடுகள்" />
        <meta property="og:title" content="ராசி குறியீடுகள் | Zodiac Signs Tamil" />
        <meta property="og:description" content="ராசி குறியீடுகள்" />
...
export default TamilZodiacSigns;