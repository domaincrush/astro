...
const TamilTopicsCareerAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>தொழில் ஜோதிடம் | Career Astrology Tamil</title>
        <meta name="description" content="தொழில் ஜோதிடம்" />
        <meta property="og:title" content="தொழில் ஜோதிடம் | Career Astrology Tamil" />
        <meta property="og:description" content="தொழில் ஜோதிடம்" />
...
export default TamilTopicsCareerAstrology;