...
const TamilLearnAstrologyDoshas = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>தோஷங்கள் மற்றும் பரிகாரங்கள் | Doshas and Remedies</title>
        <meta name="description" content="தோஷங்கள் மற்றும் பரிகாரங்கள்" />
        <meta property="og:title" content="தோஷங்கள் மற்றும் பரிகாரங்கள் | Doshas and Remedies" />
        <meta property="og:description" content="தோஷங்கள் மற்றும் பரிகாரங்கள்" />
...
export default TamilLearnAstrologyDoshas;