...
const TamilTopicsHealthAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆரோக்கிய ஜோதிடம் | Health Astrology Tamil</title>
        <meta name="description" content="ஆரோக்கிய ஜோதிடம்" />
        <meta property="og:title" content="ஆரோக்கிய ஜோதிடம் | Health Astrology Tamil" />
        <meta property="og:description" content="ஆரோக்கிய ஜோதிடம்" />
...
export default TamilTopicsHealthAstrology;