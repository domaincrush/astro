...
const TamilChartTest = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஜாதக சோதனை | Chart Test</title>
        <meta name="description" content="ஜாதக சோதனை" />
        <meta property="og:title" content="ஜாதக சோதனை | Chart Test" />
        <meta property="og:description" content="ஜாதக சோதனை" />
