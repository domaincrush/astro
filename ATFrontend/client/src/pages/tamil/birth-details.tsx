...
const TamilBirthDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பிறப்பு விவரங்கள் | Birth Details Tamil</title>
        <meta name="description" content="பிறப்பு விவரங்கள்" />
        <meta property="og:title" content="பிறப்பு விவரங்கள் | Birth Details Tamil" />
        <meta property="og:description" content="பிறப்பு விவரங்கள்" />
...
export default TamilBirthDetails;