...
export const ExecutiveDashboard: React.FC<ExecutiveDashboardProps> = ({
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 p-4 sm:p-6 lg:p-8 rounded-xl">
      {/* Header */}
      ...
      {[
        ...
        >
          <CardHeader className="bg-gradient-to-r from-orange-600 to-amber-600 text-white p-4 sm:p-6">
            <CardTitle className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl lg:text-2xl">
              {section.icon === "Calendar" && <Calendar className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Globe" && <Globe className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              ...
              {section.icon === "Shield" && <Shield className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "User" && <User className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Heart" && <Heart className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Star" && <Star className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Target" && <Target className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Sun" && <Sun className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Zap" && <Zap className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Clock" && (
              ...
              {section.icon === "Users" && <Users className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "BookOpen" && <BookOpen className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Building" && <Building className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "Diamond" && <Diamond className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />}
              {section.icon === "CheckCircle" && (
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 flex-shrink-0" />
              )}
              <span className="break-words">{section.num}. {section.title}</span>
            </CardTitle>
            {section.subtitle && (
          ...
          <CardContent className="p-4 sm:p-6 lg:p-8">
            <div className="bg-gradient-to-r from-amber-100 to-orange-100 p-4 sm:p-6 rounded-lg border border-orange-200">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-lg border border-blue-200">
                    <h4 className="text-lg sm:text-xl font-bold text-blue-800 mb-4 sm:mb-6 flex items-center gap-2">
                      ...
                      <span className="break-words">Planetary Positions at Birth</span>
                    </h4>
                            ...
                            >
                              ...
                              <div className="space-y-2 text-sm">
                                ...
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-medium">
                                    {planetData.house || "Position loading..."}
                                  </span>
                                </div>
                                <div className="flex justify-between">
                                  <span className="text-gray-600">
                    ...
                    <div className="bg-gradient-to-br from-blue-50/90 via-purple-50/90 to-indigo-50/90 backdrop-blur-sm border-purple-300 shadow-lg rounded-lg">
                      ...
                      <div className="p-8">
                        ...
                        <div className="text-center space-y-4 mb-8">
                          <div className="bg-white/90 p-4 rounded-lg border border-purple-200 shadow-sm">
                          ...
                          <div className="bg-gradient-to-br from-white to-purple-50 p-6 rounded-lg shadow-lg border border-purple-200">
                            ...
                            {reportData.divisional_charts?.d1_rasi
                              ...
                              <div className="flex justify-center items-center h-48 text-gray-500">
                                <p>North Indian Chart loading...</p>
                              </div>
                            )}
                          </div>

                          {/* South Indian Chart - D1 Chart Display */}
                          <div className="bg-gradient-to-br from-white to-orange-50 p-6 rounded-lg shadow-lg border border-orange-200">
                            <div className="text-center mb-4">
                              <h4 className="font-semibold text-orange-700 text-lg flex items-center justify-center gap-2">
              ...
              {/* Section 15: AUTHENTIC Career Analysis */}
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-6 rounded-lg border border-indigo-200">
                    <h4 className="text-xl font-bold text-indigo-800 mb-6 flex items-center gap-2">
                      ...
                      {reportData.comprehensive_career_analysis?.title ||
                        "Authentic Career Analysis"}
                    </h4>

                    {reportData.comprehensive_career_analysis ? (
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* 10th Lord Analysis - AUTHENTIC */}
                          ...
                          <div className="space-y-3">
                            <div className="p-3 bg-indigo-50 rounded-lg">
                              ...
                              <div className="text-sm text-indigo-700">
                                {
                                  reportData.comprehensive_career_analysis
                                    .tenth_lord_analysis?.interpretation
                                }
                              </div>
                            </div>
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-indigo-700">
                                  {
                                    reportData.comprehensive_career_analysis
                                      .tenth_lord_analysis?.strength_level
                                  }
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="space-y-3">
                              <div className="p-2 bg-blue-50 rounded text-sm">
                                <div className="font-medium text-blue-800">
                                  Rating:{" "}
                                  {reportData.comprehensive_annual_predictions
                                    .career_outlook?.overall_rating || "Good"}
                                </div>
                                <div className="text-blue-700 mt-1 text-xs">
                                  {reportData.comprehensive_annual_predictions
                                    .career_outlook?.jupiter_influence ||
                                    "Steady professional progress expected"}
                                </div>
                              </div>
                              <div className="space-y-1 text-xs">
                                <div className="p-2 bg-green-50 rounded text-green-800">
                                  <strong>Favorable Sectors:</strong>{" "}
                                  {reportData.comprehensive_annual_predictions
                                    .career_outlook?.favorable_sectors ||
                                    "Multiple sectors"}
                                </div>
                                <div className="p-2 bg-yellow-50 rounded text-yellow-800">
                                  <strong>Growth Potential:</strong>{" "}
                                  {reportData.comprehensive_annual_predictions
                                    .career_outlook?.growth_potential ||
                                    "Moderate development expected"}
                                </div>
                              </div>
                            </div>
                          </div>
