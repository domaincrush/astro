...
const TamilLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>முதல் பக்கம் | Landing Page Tamil</title>
        <meta name="description" content="முதல் பக்கம்" />
        <meta property="og:title" content="முதல் பக்கம் | Landing Page Tamil" />
        <meta property="og:description" content="முதல் பக்கம்" />
