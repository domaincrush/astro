...
const TamilDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>டாஷ்போர்டு | Dashboard Tamil</title>
        <meta name="description" content="பயனர் டாஷ்போர்டு" />
        <meta property="og:title" content="டாஷ்போர்டு | Dashboard Tamil" />
        <meta property="og:description" content="பயனர் டாஷ்போர்டு" />
