...
const TamilShubhMuhurat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சுப முகூர்த்தம் | Shubh Muhurat Tamil</title>
        <meta name="description" content="சுப முகூர்த்தம்" />
        <meta property="og:title" content="சுப முகூர்த்தம் | Shubh Muhurat Tamil" />
        <meta property="og:description" content="சுப முகூர்த்தம்" />
...
export default TamilShubhMuhurat;