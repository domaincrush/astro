...
const TamilLalKitab = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>லால் கிதாப் | Lal Kitab Tamil</title>
        <meta name="description" content="லால் கிதாப்" />
        <meta property="og:title" content="லால் கிதாப் | Lal Kitab Tamil" />
        <meta property="og:description" content="லால் கிதாப்" />
