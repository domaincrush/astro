...
const TamilChoghadiya = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சொகதியா | Choghadiya Tamil</title>
        <meta name="description" content="சொகதியா" />
        <meta property="og:title" content="சொகதியா | Choghadiya Tamil" />
        <meta property="og:description" content="சொகதியா" />
...
export default TamilChoghadiya;