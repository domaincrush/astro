...
const TamilLearnAstrologyAdvanced = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>மேம்பட்ட ஜோதிட நுட்பங்கள் | Advanced Techniques</title>
        <meta name="description" content="மேம்பட்ட ஜோதிட நுட்பங்கள்" />
        <meta property="og:title" content="மேம்பட்ட ஜோதிட நுட்பங்கள் | Advanced Techniques" />
        <meta property="og:description" content="மேம்பட்ட ஜோதிட நுட்பங்கள்" />
...
export default TamilLearnAstrologyAdvanced;