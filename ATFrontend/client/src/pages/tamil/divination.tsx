...
const TamilDivination = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கணிப்பு | Divination Tamil</title>
        <meta name="description" content="கணிப்பு" />
        <meta property="og:title" content="கணிப்பு | Divination Tamil" />
        <meta property="og:description" content="கணிப்பு" />
...
export default TamilDivination;