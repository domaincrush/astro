...
const TamilTopicsSadeSati = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சனி சாடே சாதி | Sade Sati Tamil</title>
        <meta name="description" content="சனி சாடே சாதி" />
        <meta property="og:title" content="சனி சாடே சாதி | Sade Sati Tamil" />
        <meta property="og:description" content="சனி சாடே சாதி" />
...
export default TamilTopicsSadeSati;