...
const TamilKpTest = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கேபி சோதனை | KP Test Tamil</title>
        <meta name="description" content="கேபி சோதனை" />
        <meta property="og:title" content="கேபி சோதனை | KP Test Tamil" />
        <meta property="og:description" content="கேபி சோதனை" />
