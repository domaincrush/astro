...
const TamilRemedies = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பரிகாரங்கள் | Remedies Tamil</title>
        <meta name="description" content="பரிகாரங்கள்" />
        <meta property="og:title" content="பரிகாரங்கள் | Remedies Tamil" />
        <meta property="og:description" content="பரிகாரங்கள்" />
