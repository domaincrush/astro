...
const TamilCheckout = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பணம் செலுத்துதல் | Checkout Tamil</title>
        <meta name="description" content="பணம் செலுத்துதல்" />
        <meta property="og:title" content="பணம் செலுத்துதல் | Checkout Tamil" />
        <meta property="og:description" content="பணம் செலுத்துதல்" />
