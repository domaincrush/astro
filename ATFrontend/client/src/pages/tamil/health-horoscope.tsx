...
const TamilHealthHoroscope = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆரோக்கிய ராசி பலன் | Health Horoscope Tamil</title>
        <meta name="description" content="ஆரோக்கிய ராசி பலன்" />
        <meta property="og:title" content="ஆரோக்கிய ராசி பலன் | Health Horoscope Tamil" />
        <meta property="og:description" content="ஆரோக்கிய ராசி பலன்" />
...
export default TamilHealthHoroscope;