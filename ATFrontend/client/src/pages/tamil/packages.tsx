...
const TamilPackages = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>தொகுப்புகள் | Packages Tamil</title>
        <meta name="description" content="தொகுப்புகள்" />
        <meta property="og:title" content="தொகுப்புகள் | Packages Tamil" />
        <meta property="og:description" content="தொகுப்புகள்" />
