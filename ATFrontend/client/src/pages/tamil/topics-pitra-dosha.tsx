...
const TamilTopicsPitraDosha = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பித்ரு தோஷம் | Pitra Dosha Tamil</title>
        <meta name="description" content="பித்ரு தோஷம்" />
        <meta property="og:title" content="பித்ரு தோஷம் | Pitra Dosha Tamil" />
        <meta property="og:description" content="பித்ரு தோஷம்" />
...
export default TamilTopicsPitraDosha;