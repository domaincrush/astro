...
const TamilCareerReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>தொழில் அறிக்கை | Career Report</title>
        <meta name="description" content="தொழில் அறிக்கை" />
        <meta property="og:title" content="தொழில் அறிக்கை | Career Report" />
        <meta property="og:description" content="தொழில் அறிக்கை" />
