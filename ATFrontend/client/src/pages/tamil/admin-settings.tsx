...
const TamilAdminSettings = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>அட்மின் அமைப்புகள் | Admin Settings</title>
        <meta name="description" content="அட்மின் அமைப்புகள்" />
        <meta property="og:title" content="அட்மின் அமைப்புகள் | Admin Settings" />
        <meta property="og:description" content="அட்மின் அமைப்புகள்" />
...
export default TamilAdminSettings;