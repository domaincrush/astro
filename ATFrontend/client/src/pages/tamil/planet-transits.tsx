...
const TamilPlanetTransits = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கிரக பெயர்ச்சிகள் | Planet Transits</title>
        <meta name="description" content="கிரக பெயர்ச்சிகள்" />
        <meta property="og:title" content="கிரக பெயர்ச்சிகள் | Planet Transits" />
        <meta property="og:description" content="கிரக பெயர்ச்சிகள்" />
...
export default TamilPlanetTransits;