...
const TamilAstrologyTools = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>ஜோதிட கருவிகள் | Astrology Tools Tamil</title>
        <meta name="description" content="ஜோதிட கருவிகள்" />
        <meta property="og:title" content="ஜோதிட கருவிகள் | Astrology Tools Tamil" />
        <meta property="og:description" content="ஜோதிட கருவிகள்" />
...
export default TamilAstrologyTools;