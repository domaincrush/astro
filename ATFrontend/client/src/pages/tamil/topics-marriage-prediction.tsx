...
const TamilTopicsMarriagePrediction = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>திருமண கணிப்பு | Marriage Prediction Tamil</title>
        <meta name="description" content="திருமண கணிப்பு" />
        <meta property="og:title" content="திருமண கணிப்பு | Marriage Prediction Tamil" />
        <meta property="og:description" content="திருமண கணிப்பு" />
...
export default TamilTopicsMarriagePrediction;