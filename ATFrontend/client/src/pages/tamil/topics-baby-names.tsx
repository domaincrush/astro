...
const TamilTopicsBabyNames = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>குழந்தை பெயர்கள் | Baby Names Tamil</title>
        <meta name="description" content="குழந்தை பெயர்கள்" />
        <meta property="og:title" content="குழந்தை பெயர்கள் | Baby Names Tamil" />
        <meta property="og:description" content="குழந்தை பெயர்கள்" />
...
export default TamilTopicsBabyNames;