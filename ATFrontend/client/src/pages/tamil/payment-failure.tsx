...
const TamilPaymentFailure = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பணம் செலுத்துதல் தோல்வி | Payment Failure</title>
        <meta name="description" content="பணம் செலுத்துதல் தோல்வி" />
        <meta property="og:title" content="பணம் செலுத்துதல் தோல்வி | Payment Failure" />
        <meta property="og:description" content="பணம் செலுத்துதல் தோல்வி" />
...
export default TamilPaymentFailure;