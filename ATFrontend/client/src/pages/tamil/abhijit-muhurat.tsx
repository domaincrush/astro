...
const TamilAbhijitMuhurat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>அபிஜித் முகூர்த்தம் | Abhijit Muhurat</title>
        <meta name="description" content="அபிஜித் முகூர்த்தம்" />
        <meta property="og:title" content="அபிஜித் முகூர்த்தம் | Abhijit Muhurat" />
        <meta property="og:description" content="அபிஜித் முகூர்த்தம்" />
...
export default TamilAbhijitMuhurat;