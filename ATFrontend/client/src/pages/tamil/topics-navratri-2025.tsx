...
const TamilTopicsNavratri2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>நவராத்திரி 2025 | Navratri 2025 Tamil</title>
        <meta name="description" content="நவராத்திரி 2025" />
        <meta property="og:title" content="நவராத்திரி 2025 | Navratri 2025 Tamil" />
        <meta property="og:description" content="நவராத்திரி 2025" />
...
export default TamilTopicsNavratri2025;