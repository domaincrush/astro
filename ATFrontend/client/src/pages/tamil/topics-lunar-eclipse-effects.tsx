...
const TamilTopicsLunarEclipseEffects = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சந்திர கிரகணம் விளைவுகள் | Lunar Eclipse Effects</title>
        <meta name="description" content="சந்திர கிரகணம் விளைவுகள்" />
        <meta property="og:title" content="சந்திர கிரகணம் விளைவுகள் | Lunar Eclipse Effects" />
        <meta property="og:description" content="சந்திர கிரகணம் விளைவுகள்" />
...
export default TamilTopicsLunarEclipseEffects;