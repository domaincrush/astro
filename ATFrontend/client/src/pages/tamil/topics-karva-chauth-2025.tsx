...
const TamilTopicsKarvaChauth2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கர்வா சௌத் 2025 | Karva Chauth 2025 Tamil</title>
        <meta name="description" content="கர்வா சௌத் 2025" />
        <meta property="og:title" content="கர்வா சௌத் 2025 | Karva Chauth 2025 Tamil" />
        <meta property="og:description" content="கர்வா சௌத் 2025" />
...
export default TamilTopicsKarvaChauth2025;