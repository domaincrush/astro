...
const TamilSpiritualGrowthAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆன்மீக வளர்ச்சி ஜோதிடம் | Spiritual Growth Astrology</title>
        <meta name="description" content="ஆன்மீக வளர்ச்சி ஜோதிடம்" />
        <meta property="og:title" content="ஆன்மீக வளர்ச்சி ஜோதிடம் | Spiritual Growth Astrology" />
        <meta property="og:description" content="ஆன்மீக வளர்ச்சி ஜோதிடம்" />
...
export default TamilSpiritualGrowthAstrology;