...
const TamilHoraTimings = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஹோரா நேரங்கள் | Hora Timings Tamil</title>
        <meta name="description" content="ஹோரா நேரங்கள்" />
        <meta property="og:title" content="ஹோரா நேரங்கள் | Hora Timings Tamil" />
        <meta property="og:description" content="ஹோரா நேரங்கள்" />
...
export default TamilHoraTimings;