...
const TamilAstrologicalReportForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஜோதிட அறிக்கை படிவம் | Astrological Report Form</title>
        <meta name="description" content="ஜோதிட அறிக்கை படிவம்" />
        <meta property="og:title" content="ஜோதிட அறிக்கை படிவம் | Astrological Report Form" />
        <meta property="og:description" content="ஜோதிட அறிக்கை படிவம்" />
...
export default TamilAstrologicalReportForm;