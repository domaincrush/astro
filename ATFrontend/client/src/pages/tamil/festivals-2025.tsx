...
const TamilFestivals2025 = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>2025 பண்டிகைகள் | Festivals 2025 Tamil</title>
        <meta name="description" content="2025 பண்டிகைகள்" />
        <meta property="og:title" content="2025 பண்டிகைகள் | Festivals 2025 Tamil" />
        <meta property="og:description" content="2025 பண்டிகைகள்" />
...
export default TamilFestivals2025;