...
const TamilLifeReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>வாழ்க்கை அறிக்கை | Life Report Tamil</title>
        <meta name="description" content="வாழ்க்கை அறிக்கை" />
        <meta property="og:title" content="வாழ்க்கை அறிக்கை | Life Report Tamil" />
        <meta property="og:description" content="வாழ்க்கை அறிக்கை" />
...
export default TamilLifeReport;