...
const TamilWealthFinanceAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>செல்வ நிதி ஜோதிடம் | Wealth Finance Astrology</title>
        <meta name="description" content="செல்வ நிதி ஜோதிடம்" />
        <meta property="og:title" content="செல்வ நிதி ஜோதிடம் | Wealth Finance Astrology" />
        <meta property="og:description" content="செல்வ நிதி ஜோதிடம்" />
...
export default TamilWealthFinanceAstrology;