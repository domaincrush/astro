...
const TamilHealthMedicalAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆரோக்கிய மருத்துவ ஜோதிடம் | Health Medical Astrology</title>
        <meta name="description" content="ஆரோக்கிய மருத்துவ ஜோதிடம்" />
        <meta property="og:title" content="ஆரோக்கிய மருத்துவ ஜோதிடம் | Health Medical Astrology" />
        <meta property="og:description" content="ஆரோக்கிய மருத்துவ ஜோதிடம்" />
...
export default TamilHealthMedicalAstrology;