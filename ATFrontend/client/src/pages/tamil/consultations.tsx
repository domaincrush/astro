...
const TamilConsultations = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆலோசனைகள் | Consultations Tamil</title>
        <meta name="description" content="ஜோதிட ஆலோசனைகள்" />
        <meta property="og:title" content="ஆலோசனைகள் | Consultations Tamil" />
        <meta property="og:description" content="ஜோதிட ஆலோசனைகள்" />
...
export default TamilConsultations;