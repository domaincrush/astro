...
const TamilSupport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆதரவு | Support Tamil</title>
        <meta name="description" content="ஆதரவு" />
        <meta property="og:title" content="ஆதரவு | Support Tamil" />
        <meta property="og:description" content="ஆதரவு" />
