...
const TamilAuthenticEastIndianChart = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>உண்மையான கிழக்கு இந்திய ஜாதகம் | Authentic East Indian Chart</title>
        <meta name="description" content="உண்மையான கிழக்கு இந்திய ஜாதகம்" />
        <meta property="og:title" content="உண்மையான கிழக்கு இந்திய ஜாதகம் | Authentic East Indian Chart" />
        <meta property="og:description" content="உண்மையான கிழக்கு இந்திய ஜாதகம்" />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-orange-800 mb-4">
            உண்மையான கிழக்கு இந்திய ஜாதகம்
          </h1>
...
export default TamilAuthenticEastIndianChart;