...
const TamilLoveMarriageAstrology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>காதல் திருமண ஜோதிடம் | Love Marriage Astrology</title>
        <meta name="description" content="காதல் திருமண ஜோதிடம்" />
        <meta property="og:title" content="காதல் திருமண ஜோதிடம் | Love Marriage Astrology" />
        <meta property="og:description" content="காதல் திருமண ஜோதிடம்" />
...
export default TamilLoveMarriageAstrology;