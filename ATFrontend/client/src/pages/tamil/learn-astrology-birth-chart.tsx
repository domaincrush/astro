...
const TamilLearnAstrologyBirthChart = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பிறப்பு ஜாதகம் கற்றல் | Birth Chart Learning</title>
        <meta name="description" content="பிறப்பு ஜாதகம் கற்றல்" />
        <meta property="og:title" content="பிறப்பு ஜாதகம் கற்றல் | Birth Chart Learning" />
        <meta property="og:description" content="பிறப்பு ஜாதகம் கற்றல்" />
...
export default TamilLearnAstrologyBirthChart;