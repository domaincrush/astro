...
const TamilSignup = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பதிவு செய்க | Signup Tamil</title>
        <meta name="description" content="பதிவு செய்க" />
        <meta property="og:title" content="பதிவு செய்க | Signup Tamil" />
        <meta property="og:description" content="பதிவு செய்க" />
