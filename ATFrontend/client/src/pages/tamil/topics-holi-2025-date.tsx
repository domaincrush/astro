...
const TamilTopicsHoli2025Date = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஹோலி 2025 தேதி | Holi 2025 Date Tamil</title>
        <meta name="description" content="ஹோலி 2025 தேதி" />
        <meta property="og:title" content="ஹோலி 2025 தேதி | Holi 2025 Date Tamil" />
        <meta property="og:description" content="ஹோலி 2025 தேதி" />
...
export default TamilTopicsHoli2025Date;