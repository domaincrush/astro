...
const TamilShippingPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஷிப்பிங் கொள்கை | Shipping Policy Tamil</title>
        <meta name="description" content="ஷிப்பிங் கொள்கை" />
        <meta property="og:title" content="ஷிப்பிங் கொள்கை | Shipping Policy Tamil" />
        <meta property="og:description" content="ஷிப்பிங் கொள்கை" />
...
export default TamilShippingPolicy;