...
const TamilFestivals = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பண்டிகைகள் | Festivals Tamil</title>
        <meta name="description" content="பண்டிகைகள்" />
        <meta property="og:title" content="பண்டிகைகள் | Festivals Tamil" />
        <meta property="og:description" content="பண்டிகைகள்" />
