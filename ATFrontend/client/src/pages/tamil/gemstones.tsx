...
const TamilGemstones = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ரத்தினக் கற்கள் | Gemstones Tamil</title>
        <meta name="description" content="ரத்தினக் கற்கள்" />
        <meta property="og:title" content="ரத்தினக் கற்கள் | Gemstones Tamil" />
        <meta property="og:description" content="ரத்தினக் கற்கள்" />
