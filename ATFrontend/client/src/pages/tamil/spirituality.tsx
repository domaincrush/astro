...
const TamilSpirituality = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஆன்மீகம் | Spirituality Tamil</title>
        <meta name="description" content="ஆன்மீகம்" />
        <meta property="og:title" content="ஆன்மீகம் | Spirituality Tamil" />
        <meta property="og:description" content="ஆன்மீகம்" />
...
export default TamilSpirituality;