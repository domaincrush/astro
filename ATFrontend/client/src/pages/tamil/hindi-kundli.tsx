...
const TamilHindiKundli = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ஹிந்தி ஜாதகம் | Hindi Kundli Tamil</title>
        <meta name="description" content="ஹிந்தி ஜாதகம்" />
        <meta property="og:title" content="ஹிந்தி ஜாதகம் | Hindi Kundli Tamil" />
        <meta property="og:description" content="ஹிந்தி ஜாதகம்" />
...
export default TamilHindiKundli;