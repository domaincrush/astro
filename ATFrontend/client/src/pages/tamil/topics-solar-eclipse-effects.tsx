...
const TamilTopicsSolarEclipseEffects = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சூரிய கிரகணம் விளைவுகள் | Solar Eclipse Effects</title>
        <meta name="description" content="சூரிய கிரகணம் விளைவுகள்" />
        <meta property="og:title" content="சூரிய கிரகணம் விளைவுகள் | Solar Eclipse Effects" />
        <meta property="og:description" content="சூரிய கிரகணம் விளைவுகள்" />
...
export default TamilTopicsSolarEclipseEffects;