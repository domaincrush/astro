...
const TamilTopicsKaalSarpDosha = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>கால சர்ப்ப தோஷம் | Kaal Sarp Dosha Tamil</title>
        <meta name="description" content="கால சர்ப்ப தோஷம்" />
        <meta property="og:title" content="கால சர்ப்ப தோஷம் | Kaal Sarp Dosha Tamil" />
        <meta property="og:description" content="கால சர்ப்ப தோஷம்" />
...
export default TamilTopicsKaalSarpDosha;