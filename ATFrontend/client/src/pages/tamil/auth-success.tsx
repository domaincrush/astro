...
const TamilAuthSuccess = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>அங்கீகார வெற்றி | Auth Success Tamil</title>
        <meta name="description" content="அங்கீகார வெற்றி" />
        <meta property="og:title" content="அங்கீகார வெற்றி | Auth Success Tamil" />
        <meta property="og:description" content="அங்கீகார வெற்றி" />
...
export default TamilAuthSuccess;