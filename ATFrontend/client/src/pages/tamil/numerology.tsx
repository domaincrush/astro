...
const TamilNumerology = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>எண்கணிதம் | Numerology Tamil</title>
        <meta name="description" content="எண்கணிதம்" />
        <meta property="og:title" content="எண்கணிதம் | Numerology Tamil" />
        <meta property="og:description" content="எண்கணிதம்" />
...
export default TamilNumerology;