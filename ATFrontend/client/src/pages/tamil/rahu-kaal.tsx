...
const TamilRahuKaal = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>ராகு காலம் | Rahu Kaal Tamil</title>
        <meta name="description" content="ராகு காலம்" />
        <meta property="og:title" content="ராகு காலம் | Rahu Kaal Tamil" />
        <meta property="og:description" content="ராகு காலம்" />
