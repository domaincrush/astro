...
const TamilAstrologerProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>ஜோதிடர் சுயவிவரம் | Astrologer Profile</title>
        <meta name="description" content="ஜோதிடர் சுயவிவரம்" />
        <meta property="og:title" content="ஜோதிடர் சுயவிவரம் | Astrologer Profile" />
        <meta property="og:description" content="ஜோதிடர் சுயவிவரம்" />
...
export default TamilAstrologerProfile;