...
const TamilBrihatKundliResults = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>விரிவான ஜாதக பலன்கள் | Brihat Kundli Results</title>
        <meta name="description" content="விரிவான ஜாதக பலன்கள்" />
        <meta property="og:title" content="விரிவான ஜாதக பலன்கள் | Brihat Kundli Results" />
...
export default TamilBrihatKundliResults;