...
const TamilTopicsMangalDosha = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>மங்கள தோஷம் | Mangal Dosha Tamil</title>
        <meta name="description" content="மங்கள தோஷம்" />
        <meta property="og:title" content="மங்கள தோஷம் | Mangal Dosha Tamil" />
        <meta property="og:description" content="மங்கள தோஷம்" />
...
export default TamilTopicsMangalDosha;