...
const TamilArticlesDashaPeriodsGuide = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <Helmet>
        <title>தசா காலங்கள் வழிகாட்டி | Dasha Periods Guide</title>
        <meta name="description" content="தசா காலங்கள் வழிகாட்டி" />
        <meta property="og:title" content="தசா காலங்கள் வழிகாட்டி | Dasha Periods Guide" />
        <meta property="og:description" content="தசா காலங்கள் வழிகாட்டி" />
...
export default TamilArticlesDashaPeriodsGuide;