...
const TamilChildReport = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>குழந்தை அறிக்கை | Child Report</title>
        <meta name="description" content="குழந்தை அறிக்கை" />
        <meta property="og:title" content="குழந்தை அறிக்கை | Child Report" />
        <meta property="og:description" content="குழந்தை அறிக்கை" />
