...
const TamilLearnAstrologyMuhurta = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>முகூர்த்த நேரம் | Muhurta Timing</title>
        <meta name="description" content="முகூர்த்த நேரம்" />
        <meta property="og:title" content="முகூர்த்த நேரம் | Muhurta Timing" />
        <meta property="og:description" content="முகூர்த்த நேரம்" />
...
export default TamilLearnAstrologyMuhurta;