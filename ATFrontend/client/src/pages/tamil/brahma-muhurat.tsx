...
const TamilBrahmaMuhurat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>பிரம்ம முகூர்த்தம் | Brahma Muhurat Tamil</title>
        <meta name="description" content="பிரம்ம முகூர்த்தம்" />
        <meta property="og:title" content="பிரம்ம முகூர்த்தம் | Brahma Muhurat Tamil" />
        <meta property="og:description" content="பிரம்ம முகூர்த்தம்" />
...
export default TamilBrahmaMuhurat;