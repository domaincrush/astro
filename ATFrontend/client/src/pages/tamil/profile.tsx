...
const TamilProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>சுயவிவரம் | Profile Tamil</title>
        <meta name="description" content="சுயவிவரம்" />
        <meta property="og:title" content="சுயவிவரம் | Profile Tamil" />
        <meta property="og:description" content="சுயவிவரம்" />
