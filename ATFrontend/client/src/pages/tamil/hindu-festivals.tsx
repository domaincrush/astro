...
const TamilHinduFestivals = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>இந்து பண்டிகைகள் | Hindu Festivals Tamil</title>
        <meta name="description" content="இந்து பண்டிகைகள்" />
        <meta property="og:title" content="இந்து பண்டிகைகள் | Hindu Festivals Tamil" />
        <meta property="og:description" content="இந்து பண்டிகைகள்" />
...
export default TamilHinduFestivals;