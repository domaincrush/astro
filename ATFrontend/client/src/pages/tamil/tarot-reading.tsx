...
const TamilTarotReading = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>டாரட் ரீடிங் | Tarot Reading Tamil</title>
        <meta name="description" content="டாரட் ரீடிங்" />
        <meta property="og:title" content="டாரட் ரீடிங் | Tarot Reading Tamil" />
        <meta property="og:description" content="டாரட் ரீடிங்" />
...
export default TamilTarotReading;