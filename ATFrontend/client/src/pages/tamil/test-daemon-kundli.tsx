...
const TamilTestDaemonKundli = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      <Helmet>
        <title>டேமன் ஜாதக சோதனை | Daemon Kundli Test</title>
        <meta name="description" content="டேமன் ஜாதக சோதனை" />
        <meta property="og:title" content="டேமன் ஜாதக சோதனை | Daemon Kundli Test" />
        <meta property="og:description" content="டேமன் ஜாதக சோதனை" />
...
export default TamilTestDaemonKundli;